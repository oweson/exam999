						...
						<div class="row">
							...
							<form class="bs-example bs-example-form col-md-5" role="form" style="margin: 20px 0 10px 0;" action="/admin/selectStudent" id="form1" method="post">
								<div class="input-group">
									...
									<input type="text" class="form-control" placeholder="请输入电话" name="findByTel">
									<input type="text" class="form-control" placeholder="请输入学号" name="findByNum">
									<input type="text" class="form-control" placeholder="第一搜索可用，其他的todo>.."
										   name="findByNum">
